...
<body>
    <h1>Update {{ $student->firstname }} {{ $student->lastname }}</h2>
    ...
    <div class="form-container">
        <form method="POST" autocomplete="on" autocapitalize="on" action="{{ url('store') }}">
            ...
            <input class="form-input" type="image" name='pic' id='pic' placeholder="Picture"><br><br>

            <input class="page-button" id="Submit" type="submit" value="Update" > <!--"Update" Button-->
